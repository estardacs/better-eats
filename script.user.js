      ...
      function appendTypesFilter() {
        ...
        <div class="flex items-center space-x-2">
          <input
            ...
            type="checkbox"
          />
            <label class="uk-form-label" for="toggle-switch">2X1</label>
        </div>
        `);
        ...
        <div class="flex items-center space-x-2 mt-3">
          <input
            ...
            type="checkbox"
          />
            <label class="uk-form-label" for="toggle-switch">Gasta y ahorra</label>
        </div>
        `);
        ...
        <div class="flex items-center space-x-2 mt-3">
          <input
            ...
            type="checkbox"
          />
            <label class="uk-form-label" for="toggle-switch">Ofertas disponibles</label>
        </div>
        `);
